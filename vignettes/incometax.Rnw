...
Although in this last example the result is identical to that obtained by adding the value of the
pay adjustment to argument \code{income} (see the previous example), that may not always be
the~case:~--
