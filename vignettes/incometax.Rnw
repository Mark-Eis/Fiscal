...
As intended using this allowance, an \emph{exact} total of \pounds600 income tax is recouped:~--
...
As intended using this allowance, a total of \emph{at least} \pounds600 income tax is recouped:~--
...
\pagebreak
As intended using this allowance, a total of \emph{at least} \pounds800 income tax is recouped i.e.,
\\an additional amount of at least \pounds600:~--
...
As intended using this allowance, a total of \emph{at least} \pounds9,140 income tax is recouped
i.e.,\\an additional amount of at least \pounds1,200:~--
...
decreases by half to \Sexpr{prettyL(std_allow / 2)}, usually attracts
\Sexpr{prettyL(sum(incometax(allow_upper + std_allow)))} in income tax:~--

<<>>=
incometax(112570)
@

At this income, removing the Personal Allowance entirely would still not be sufficient to recoup an
\emph{additional} tax deficit of say \pounds3,500 i.e., a total of
...
Instead, a pay adjustment is required, as indicated by the negative value returned by
\code{allowance()}:~--
...
of \emph{at least} \Sexpr{prettyL(sum(incometax(allow_upper + std_allow, -2460)))} income tax is
recouped i.e., an additional amount of  at least \pounds3,500:~--
